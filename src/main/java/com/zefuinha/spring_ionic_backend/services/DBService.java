...
public class DBService {
	...
	public void instantiateTestDataBase() throws ParseException {
		...
		// Produtos para testar Infinity Scroll
		...
		// Cliente Admin
		Cliente cli1 = new Cliente(null, "Daniel Bispo", "danielbispo.sp64@gmail.com", "304.714.108-88", TipoCliente.PF,
				passEncoder.encode("Teste1234"));
		cli1.getTelefones().addAll(Arrays.asList("19997014416", "1996707272"));
		cli1.addPerfil(Perfil.ADMIN);

		// Cliente comum
		Cliente cli2 = new Cliente(null, "Maria Silva", "maria@gmail.com", "057.139.540-64", TipoCliente.PF,
				passEncoder.encode("1234"));
